...
@section('content')
   <div class="col-md-12">
        <div class="card card-transparent card-block card-stretch card-height border-none">
            ...
            <div class="card-body">
            @foreach($data as $row)
                <form class="form-horizontal" action="{{url('/pemantauan-efektivitas/'.$row->id)}}" method="post">
                    @csrf
                    <input type="hidden" name="_method" value="put">
                    <div class="form-group">
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center" for="">Unit Kerja Pemilik Risiko<i class="bintang">*</i></label>
                        <div class="col-sm-9">
                            <!-- Select2 -->
                            ...
                            <input type="hidden" name="id_manajemen" id="id_manajemen" value="{{$row->id_manajemen}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @foreach($data_risiko as $dtr)
                                <option value="{{$dtr->id}}"@if($dtr->id==$row->id_risiko) selected @endif>{{$dtr->full_kode}}</option>
                            @endforeach
                            </select>
                            <input type="hidden" name="id_risiko" id="id_risiko" value="{{$row->id_risiko}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            @foreach($data_pengendalian as $dtp)
                                <option value="{{$dtp->id}}"@if($dtp->id==$row->id_pengendalian) selected @endif>{{$dtp->kode_tindak_pengendalian}}</option>
                            @endforeach
                            </select>
                            <input type="hidden" name="id_pengendalian" id="id_pengendalian" value="{{$row->id_pengendalian}}" required>
                            <!-- <input type="hidden" name="id_departemen" id="id_departemen"> -->
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="kegiatan_pengendalian" id="kegiatan_pengendalian" rows="5" required>{{$row->kegiatan_pengendalian}}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="frekuensi_saat_ini"
                                    name="frekuensi_saat_ini" placeholder="" value="{{$row->frekuensi_saat_ini}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center" for="email">Skor dampak yang direspons</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="dampak_saat_ini" value="{{$row->dampak_saat_ini}}" name="dampak_saat_ini"
                                    readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="besaran_saat_ini" id="besaran_saat_ini" class="box1" value="{{$row->besaran_saat_ini}}" style="background-color: {{$row->pr_saat_ini}}" readonly>
                                <input type="hidden" name="pr_saat_ini" id="pr_saat_ini" value="{{$row->pr_saat_ini}}">
                            </div>
                        </div>
                    </fieldset>
                    <fieldset class="scheduler-border">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="frekuensi_akhir"
                                    name="frekuensi_akhir" value="{{$row->frekuensi_akhir}}" readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center" for="email">Skor Dampak Aktual </label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="dampak_akhir" name="dampak_akhir" value="{{$row->dampak_akhir}}"
                                    readonly>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="besaran_akhir" id="besaran_akhir" class="box1" value="{{$row->besaran_akhir}}" style="background-color: {{$row->pr_akhir}}" readonly>
                                <input type="hidden" name="pr_akhir" id="pr_akhir" value="{{$row->pr_akhir}}">
                            </div>
                        </div>
                    </fieldset>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control" name="keterangan" id="keterangan" rows="5">{{$row->keterangan}}</textarea>
                        </div>
                    </div>
                    <!-- <fieldset class="scheduler-border">
