            ...
            <div class="card-body p-0 mt-lg-2 mt-0">
                ...
                <div class="form-group">
                    <div class="text-right">
                        <a href="{{url('klasifikasisubunsurspip/create')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Tambah Klasifikasi Sub Unsur SPIP</a>
                    </div>
                </div>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" action="{{url('klasifikasisubunsurspip')}}" method="post">
                                                @csrf
                                                <div class="form-group row">
                                                    <label class="control-label col-sm-3 align-self-center" for="">Klasifikasi Sub Unsur SPIP</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="klasifikasi_sub_unsur_spip" class="form-control" value="{{$item->klasifikasi_sub_unsur_spip}}" id="" readonly required>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
...
@push('script')
    ...
    <script src="{{asset('assets/customjs/backend/klasifikasisubunsurspip.js')}}"></script>
@endpush
