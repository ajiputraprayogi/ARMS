            ...
            <div class="card-body p-0 mt-lg-2 mt-0">
                ...
                <div class="form-group">
                    <div class="text-right">
                        <a href="{{url('dampak/create')}}" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Tambah Kriteria</a>
                    </div>
                </div>
                            ...
                            <div class="modal fade" id="show{{$item->id}}" tabindex="-1" role="dialog"  aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Kriteria Dampak</h5>
...
@push('script')
    ...
    <script src="{{asset('assets/customjs/backend/dampak.js')}}"></script>
@endpush
