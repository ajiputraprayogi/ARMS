            ...
            <form class="form-horizontal" action="{{url('resiko-teridentifikasi/'.$res->id)}}" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" id="tahun" name="tahun" readonly value="{{$res->periode_penerapan}}">
                        </select>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <input type="hidden" name="namakonteks" id="nama_konteks" value="{{$res->id_konteks}}">
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" name="kategori" id="">
                            <option selected value="{{$res->ikat}}">{{$res->namakat}}</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="md-form md-outline input-with-post-icon datepicker">
                            <input placeholder="Select date" type="date" id="example" class="form-control"  name="tanggal_pengajuan" value="{{$res->diajukan_tanggal}}">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="control-label col-sm-3 align-self-center" for="email">Disetujui/Ditolak Oleh<i
                            class="bintang">*</i></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="disetujui_oleh" value="{{$res->persetujuan_oleh}}">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="md-form md-outline input-with-post-icon datepicker">
                            <input placeholder="Select date" type="date" id="example" class="form-control" name="tanggal_persetujuan" value="{{$res->tanggal_persetujua}}">
                        </div>
                    </div>
                </div>
                <div class="form-group row">
