   ...
   <div class="col-md-12">
        <div class="card card-transparent card-block card-stretch card-height border-none">
            <div class="card-header p-0 mt-lg-2 mt-0">
                <h3 class="mb-3">Tambah Periode Pelaporan</h3>
            </div>
            @if ($errors->any())
            ...
            <div class="card-body">
                <form class="form-horizontal" action="{{url('periodepelaporan')}}" method="post">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" name="tanggal_mulai" class="form-control" id="" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="control-label col-sm-3 align-self-center" for="">Tanggal Selesai</label>
                        <div class="col-sm-9">
                            <input type="date" name="tanggal_selesai" class="form-control" id="" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="nama_periode" class="form-control" id="" required>
                        </div>
                    </div>
