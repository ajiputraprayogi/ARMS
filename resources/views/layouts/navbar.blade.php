<div class="iq-sidebar  sidebar-default ">
          <div class="iq-sidebar-logo d-flex align-items-center justify-content-between">
              <a href="{{url('/')}}" class="header-logo">
                  <img src="{{asset('assets/images/logo kementan.png')}}" class="img-fluid rounded-normal light-logo" alt="logo"><h5 class="logo-title light-logo ml-3">ARMS</h5>
              </a>
          ...
          <div class="data-scrollbar" data-scroll="1">
              <nav class="iq-sidebar-menu">
                  <ul id="iq-sidebar-toggle" class="iq-menu">
                          ...
                          <ul id="dashboard" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{url('/dashboard')}}">
                                      <i class="las la-minus"></i><span>Dashboard Utama</span>
                                  </a>
                                  <a href="{{url('/dashboard-risiko')}}">
                                      <i class="las la-minus"></i><span>Dashboard Risiko</span>
                                  </a>
                                  <a href="{{url('/dashboard-penyebab')}}">
                      ...
                      <li class="" class="svg-icon">
                          <a href="#manajemenrisiko" class="collapsed" data-toggle="collapse" aria-expanded="false">
                              <!-- <svg class="svg-icon" id="p-dash2" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                                  <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                              </svg> -->
                              <span class="ml-4">Manajemen Risiko</span>
                              <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                  <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                              </svg>
                          </a>
                          <ul id="manajemenrisiko" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{url('pelaksanaan')}}">
                                      <i class="las la-minus"></i><span>Pelaksanaan Manajemen</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
                      <li class="" class="svg-icon">
                          <a href="#risiko" class="collapsed" data-toggle="collapse" aria-expanded="false">
                              <!-- <svg class="svg-icon" id="p-dash2" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                                  <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                              </svg> -->
                              <span class="ml-4">Risiko</span>
                              <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                  <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                              </svg>
                          </a>
                      ...
                      <li class="" class="svg-icon">
                          <a href="#penangananrisiko" class="collapsed" data-toggle="collapse" aria-expanded="false">
                              <!-- <svg class="svg-icon" id="p-dash2" width="20" height="20"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle>
                                  <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path>
                              </svg> -->
                              <span class="ml-4">Penangangan Risiko</span>
                              <svg class="svg-icon iq-arrow-right arrow-active" width="20" height="20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                  <polyline points="10 15 15 20 20 15"></polyline><path d="M4 4h7a4 4 0 0 1 4 4v12"></path>
                              </svg>
                          </a>
                          <ul id="penangananrisiko" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{url('pengendalian')}}">
                                      <i class="las la-minus"></i><span>Tindak Pengendalian</span>
                                  </a>
                      ...
                      <li class="" class="svg-icon">
                          ...
                          <ul id="laporanpengelolaanrisiko" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="{{url('pelaporan-pengelolaan-risiko')}}">
                      ...
                      <li class="" class="svg-icon">
                          ...
                          <ul id="masterdata" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              ...
                              <li class="">
                                  <a href="{{url('dampak')}}">
                                      <i class="las la-minus"></i><span>Kriteria Dampak</span>
                                  </a>
                              </li>
                              <li class="">
                              ...
                              <li class="">
                                  <a href="{{url('jeniskonteks')}}">
                                      <i class="las la-minus"></i><span>Jenis Konteks</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="{{url('penyebab')}}">
                              ...
                              <li class="">
                                  <a href="{{url('metodepencapaiantujuanspip')}}" title="Metode Pencapaian Tujuan SPIP">
                                      <i class="las la-minus"></i><span>Metode Pencapaian Tujuan SPIP</span>
                                  </a>
                              </li>
                              <li class="">
                      ...
                      <!-- <li class=" ">
                          ...
                          <ul id="transaksi" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                              <li class="">
                                  <a href="">
                                      <i class="las la-minus"></i><span>Pesanan Baru</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="">
                                      <i class="las la-minus"></i><span>Perlu Dicek</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="">
                                      <i class="las la-minus"></i><span>Perlu Dikirim</span>
                                  </a>
                              </li>
                              <li class="">
                                  <a href="">
                                      <i class="las la-minus"></i><span>Barang Di Kirim</span>
                                  </a>
                              </li>
                          </ul>
                      </li>
